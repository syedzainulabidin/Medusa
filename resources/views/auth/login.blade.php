   ...
   @section('title', 'Login - Medusa Vaccination System (MVS)')
   @section('content')
       <div class="container login">
           <div class="vector">
               <svg xmlns="http://www.w3.org/2000/svg" width="793" height="551.73152" viewBox="0 0 793 551.73152"
                   ...
                   <polygon
                       ...
                       fill="#2f2e41" />
                   <circle cx="707.33457" cy="77.37523" r="77.37523" fill="#28443f" />
                   <path
                   ...
                   <path
                       ...
                       transform="translate(-203.5 -174.13424)" fill="#28443f" />
                   <path
               ...
               <div class="content">
                   <div class="form-container">
                       ...
                       <p class="signup-link">
                           ...
                           <a href="{{ url('/register') }}" class="signup-link link"> Register now</a>
                       </p>
                   </div>
               </div>
           </div>
